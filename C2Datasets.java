...
class DataSet {
    ...
    public double getStandardDeviation() {
        ...
        for (int i = 0; i < dataSize; i++){
            ...
            sumOfSquares += diff*diff; // more efficient that Math.pow(diff, 2)
        }
...
public class C2Datasets {
    public static void main(String[] args){
        ...
        // Test part b): Averages of Averages
        ...
        System.out.println("Avereages of Averages: " + DataSet.calculateAverage(datasets));
    }
}
